        ...
        return(
          <div className="sidebar-wrapper" style = {{display:"flex", flexDirection: 'column' }}>
            <div style = {{padding : "20px",borderLeft:(this.props.activeComponent == 'home')?'solid 3px #2d8259':'',marginTop : '121px'}}>
             <Link to={ this.props.type==="commercial" ? '/homeCommercial' : '/home' }> <img style = {{cursor:'pointer'}} className = 'ic_home' src = {this.props.activeComponent == 'home'?'./images/home.png':'./images/ichome.png'} /></Link>
            </div>
